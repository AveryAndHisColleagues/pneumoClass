...
for epoch in range(epochs):
    ...
    if val_acc > best_val_acc:
        ...
        bad_epochs = 0
        torch.save(model.state_dict(), "checkpoints/best_resnet18.pth")
        print(f"Saved best ResNet18! Best Val Acc={best_val_acc:.4f}")
    else:
        bad_epochs += 1
...
print(f"Final ResNet18 Test Acc = {test_acc:.4f}")